...
const App = () => {
  ...
  const sendGif = async () => {
    ...
    try {
      ...
      console.log('Gif link successfully sent to program', inputValue);
      await getGifList();
    } catch(error) {
      console.log('Error while sending GIF:', error);
    }
  };
          ...
          <div className="gif-grid">
            ...
            {gifList.map((item, index) => (
              <div className="gif-item" key={index}>
                ...
                <span className='footer-text'>{item.userAddress.toString()}</span>
              </div>
            ))}
          </div>
        </div>
